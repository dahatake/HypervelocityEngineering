...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-22T12:04:27 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-15T03:04:27+00:00 |
| レコード数 | 5 |
...
| E1 索引サイズ - チャンク数 | 5035 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-22T12:04:27 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=1, search=3, stats=1 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 2.5 |
| A2 総呼び出し回数 | 5 |
...
| D3 典型クエリ出現率 (合算) | 0 |
| D3 合算マッチ件数 | 0 |
| D3 合算 search 総件数 (patterns 定義済み workflow のみ) | 2 |
| D3 aad-web 出現率 | 0 |
| D3 aad-web マッチ件数 | 0 |
| D3 aad-web search 総件数 | 2 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9354 |
| B1 snippet 文字数合計 | 1495 |
| B1 参照元ファイル文字数合計 | 23134 |
| B2 top_k 平均 | 6.67 |
| B2 max_tokens 平均 | 800 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 0 |
| F1 search 実行時間 p95 (ms) | 333.9 |
| F1 サンプルサイズ | 3 |
