...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-15T21:48:37 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-08T12:48:32+00:00 |
| レコード数 | 81 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-15T21:48:32 |
| E5 孤児チャンク削除累計 (件) | 0 |
| E5 集計対象 index 実行回数 | 1 |
| F2 索引差分更新比率 | 0.5824 |
| F2 サンプルサイズ | 1 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=1, search=70, stats=10 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 2.57 |
| A2 総呼び出し回数 | 54 |
| A2 distinct Step 数 | 21 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9806 |
| B1 snippet 文字数合計 | 110705 |
| B1 参照元ファイル文字数合計 | 5715569 |
| B2 top_k 平均 | 6.23 |
| B2 max_tokens 平均 | 1055.71 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 178 |
| F1 search 実行時間 p95 (ms) | 419.75 |
| F1 サンプルサイズ | 70 |
| G1 mdq 利用 Step 完了率差 | 0.2408 |
| G1 利用 run 平均 | 0.8611 |
| G1 未利用 run 平均 | 0.6203 |
| G1 利用 run 数 | 6 |
| G1 未利用 run 数 | 39 |
