...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-07-13T09:20:29 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-07-06T00:20:22+00:00 |
| レコード数 | 74 |
...
| E1 索引サイズ - チャンク数 | 5035 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-07-13T09:20:29 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | search=44, stats=30 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 2.55 |
| A2 総呼び出し回数 | 74 |
| A2 distinct Step 数 | 29 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9525 |
| B1 snippet 文字数合計 | 90695 |
| B1 参照元ファイル文字数合計 | 1910839 |
| B2 top_k 平均 | 5.82 |
| B2 max_tokens 平均 | 1047.73 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 459 |
| F1 search 実行時間 p95 (ms) | 1004.2 |
| F1 サンプルサイズ | 44 |
