...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-29T02:53:04 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-21T17:53:04+00:00 |
| レコード数 | 144 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-29T02:53:04 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | search=120, stats=24 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 11.83 |
| A2 総呼び出し回数 | 142 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9623 |
| B1 snippet 文字数合計 | 134231 |
| B1 参照元ファイル文字数合計 | 3561192 |
| B2 top_k 平均 | 7.42 |
| B2 max_tokens 平均 | 1178.33 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 37 |
| F1 search 実行時間 p95 (ms) | 237.6 |
| F1 サンプルサイズ | 120 |
