...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-17T04:40:21 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-09T19:40:21+00:00 |
| レコード数 | 20 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-17T04:40:21 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=1, search=19 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 3.33 |
| A2 総呼び出し回数 | 20 |
| A2 distinct Step 数 | 6 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9809 |
| B1 snippet 文字数合計 | 32109 |
| B1 参照元ファイル文字数合計 | 1676927 |
| B2 top_k 平均 | 6.68 |
| B2 max_tokens 平均 | 1100 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 171 |
| F1 search 実行時間 p95 (ms) | 311.5 |
| F1 サンプルサイズ | 19 |
