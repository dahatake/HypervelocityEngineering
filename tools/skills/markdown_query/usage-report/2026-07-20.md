...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-07-20T14:41:03 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-07-13T05:41:02+00:00 |
| レコード数 | 74 |
...
| E1 索引サイズ - チャンク数 | 3367 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-07-20T14:41:03 |
| E5 孤児チャンク削除累計 (件) | 1646 |
| E5 集計対象 index 実行回数 | 2 |
| F2 索引差分更新比率 | 0.1827 |
| F2 サンプルサイズ | 2 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | get=15, index=2, search=52, stats=5 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 34 |
| A2 総呼び出し回数 | 68 |
| A2 distinct Step 数 | 2 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9644 |
| B1 snippet 文字数合計 | 123467 |
| B1 参照元ファイル文字数合計 | 3468904 |
| B2 top_k 平均 | 9.79 |
| B2 max_tokens 平均 | 2734.62 |
| B2 snippet_radius 平均 | 2 |
| B2 サンプルサイズ | 52 |
| B3 get/search 比率 | 0.2885 |
| B3 get 回数 | 15 |
| B3 search 回数 | 52 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 146.5 |
| F1 search 実行時間 p95 (ms) | 461.9 |
| F1 サンプルサイズ | 52 |
