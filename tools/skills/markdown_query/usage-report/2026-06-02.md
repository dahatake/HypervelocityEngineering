...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-02T00:52:07 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-05-25T15:52:07+00:00 |
| レコード数 | 490 |
...
| E1 索引サイズ - チャンク数 | 2996 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-02T00:52:07 |
| E5 孤児チャンク削除累計 (件) | 7876 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=3, search=487 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 6.53 |
| A2 総呼び出し回数 | 490 |
| A2 distinct Step 数 | 75 |
| A4 Skill _routing 記載 | はい |
| D1 DO NOT USE FOR 違反 (件) | 0 |
| D3 典型クエリ出現率 (合算) | 0.0273 |
| D3 合算マッチ件数 | 3 |
| D3 合算 search 総件数 (patterns 定義済み workflow のみ) | 110 |
| D3 aad-web 出現率 | 0.0273 |
| D3 aad-web マッチ件数 | 3 |
| D3 aad-web search 総件数 | 110 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9832 |
| B1 snippet 文字数合計 | 624001 |
| B1 参照元ファイル文字数合計 | 37050997 |
| B2 top_k 平均 | 5.62 |
| B2 max_tokens 平均 | 1133.68 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 501 |
| F1 search 実行時間 p95 (ms) | 3055.4 |
| F1 サンプルサイズ | 487 |
