...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-12T08:56:34 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-04T23:56:31+00:00 |
| レコード数 | 76 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-12T08:56:31 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=1, search=65, stats=10 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 2.33 |
| A2 総呼び出し回数 | 49 |
...
| B1 snippet 文字数合計 | 99477 |
| B1 参照元ファイル文字数合計 | 5117723 |
| B2 top_k 平均 | 6.17 |
| B2 max_tokens 平均 | 1063.08 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 176 |
| F1 search 実行時間 p95 (ms) | 387.2 |
| F1 サンプルサイズ | 65 |
| G1 mdq 利用 Step 完了率差 | 0.2252 |
| G1 利用 run 平均 | 0.8333 |
| G1 未利用 run 平均 | 0.6081 |
| G1 利用 run 数 | 5 |
| G1 未利用 run 数 | 36 |
| G1 mdq 利用 run_id 数 | 5 |
