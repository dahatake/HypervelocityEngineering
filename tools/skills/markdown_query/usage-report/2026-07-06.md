...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-07-06T10:24:32 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-29T01:24:31+00:00 |
| レコード数 | 7 |
...
| E1 索引サイズ - チャンク数 | 5035 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-07-06T10:24:32 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | search=5, stats=2 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 1.5 |
| A2 総呼び出し回数 | 3 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9883 |
| B1 snippet 文字数合計 | 5977 |
| B1 参照元ファイル文字数合計 | 509142 |
| B2 top_k 平均 | 8.2 |
| B2 max_tokens 平均 | 1240 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 369 |
| F1 search 実行時間 p95 (ms) | 643.8 |
| F1 サンプルサイズ | 5 |
