...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-30T03:00:50 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-22T18:00:50+00:00 |
| レコード数 | 127 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-30T03:00:50 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | search=106, stats=21 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 10.42 |
| A2 総呼び出し回数 | 125 |
| A2 distinct Step 数 | 12 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9655 |
| B1 snippet 文字数合計 | 114268 |
| B1 参照元ファイル文字数合計 | 3316141 |
| B2 top_k 平均 | 7.44 |
| B2 max_tokens 平均 | 1177.36 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 45.5 |
| F1 search 実行時間 p95 (ms) | 273.5 |
| F1 サンプルサイズ | 106 |
