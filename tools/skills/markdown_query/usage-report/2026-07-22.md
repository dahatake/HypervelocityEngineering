...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-07-22T02:51:30 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-07-14T17:51:30+00:00 |
| レコード数 | 171 |
...
| E1 索引サイズ - チャンク数 | 3461 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-07-22T02:51:30 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | get=42, index=8, search=106, stats=15 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 52.67 |
| A2 総呼び出し回数 | 158 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.958 |
| B1 snippet 文字数合計 | 247169 |
| B1 参照元ファイル文字数合計 | 5887401 |
| B2 top_k 平均 | 9.07 |
| B2 max_tokens 平均 | 2034.91 |
| B2 snippet_radius 平均 | 2 |
| B2 サンプルサイズ | 106 |
| B3 get/search 比率 | 0.3962 |
| B3 get 回数 | 42 |
| B3 search 回数 | 106 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 90 |
| F1 search 実行時間 p95 (ms) | 450 |
| F1 サンプルサイズ | 106 |
