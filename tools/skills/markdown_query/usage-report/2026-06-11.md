...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-06-11T00:17:22 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-06-03T15:17:19+00:00 |
| レコード数 | 72 |
...
| E1 索引サイズ - チャンク数 | 3409 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-06-11T00:17:19 |
| E5 孤児チャンク削除累計 (件) | 0 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=1, search=61, stats=10 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 2.14 |
| A2 総呼び出し回数 | 45 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9796 |
| B1 snippet 文字数合計 | 95331 |
| B1 参照元ファイル文字数合計 | 4680363 |
| B2 top_k 平均 | 6.08 |
| B2 max_tokens 平均 | 1026.23 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 180 |
| F1 search 実行時間 p95 (ms) | 395 |
| F1 サンプルサイズ | 61 |
| G1 mdq 利用 Step 完了率差 | 0.2703 |
| G1 利用 run 平均 | 0.875 |
| G1 未利用 run 平均 | 0.6047 |
| G1 利用 run 数 | 4 |
| G1 未利用 run 数 | 34 |
| G1 mdq 利用 run_id 数 | 4 |
