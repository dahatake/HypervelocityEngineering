...
3. **方式 3: ワークフローオーケストレーション（ローカル）** — Python SDK でローカル実行（[Work IQ 連携](users-guide/hve-app-guide.md#work-iq-mcp-連携オプション)対応） → [hve-app-guide.md](users-guide/hve-app-guide.md)
...
| **03 — Microservice 設計** | [03-app-design-microservice-azure.md](users-guide/03-app-design-microservice-azure.md) | `aad-web` |
| **04 — Batch 設計** | [04-app-design-batch.md](users-guide/04-app-design-batch.md) | `abd` |
| **05 — Microservice 実装** | [05-app-dev-microservice-azure.md](users-guide/05-app-dev-microservice-azure.md) | `asdw-web` |
| **06 — Batch 実装** | [06-app-dev-batch-azure.md](users-guide/06-app-dev-batch-azure.md) | `abdv` |
| **07 — AI Agent（Quick）** | [07-ai-agent-simple.md](users-guide/07-ai-agent-simple.md) | `aag` |
| **08 — AI Agent（本格）** | [08-ai-agent.md](users-guide/08-ai-agent.md) | `aagd` |
...
> 01（要求定義）は手動実行です。それ以外はワークフローによる自動実行が可能です。

---

## ドキュメント一覧

以下の図はドキュメント間の参照関係と構造を示すナビゲーションマップです。

![ドキュメントナビゲーションマップ](users-guide/images/doc-navigation-map.svg)
...
| [hve-app-guide.md](users-guide/hve-app-guide.md) | 方式 3: hve アプリケーション ユーザーガイド（ローカル実行） |
...
│   ├── hve-app-guide.md            ← 方式3: hve アプリケーション ユーザーガイド（ローカル実行）
