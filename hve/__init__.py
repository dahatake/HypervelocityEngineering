...
try:
    ...
    from .prompts import QA_PROMPT, QA_APPLY_PROMPT, REVIEW_PROMPT, CODE_REVIEW_AGENT_FIX_PROMPT, CODE_REVIEW_CLI_PROMPT, ADVERSARIAL_RECHECK_PROMPT
    ...
    from prompts import QA_PROMPT, QA_APPLY_PROMPT, REVIEW_PROMPT, CODE_REVIEW_AGENT_FIX_PROMPT, CODE_REVIEW_CLI_PROMPT, ADVERSARIAL_RECHECK_PROMPT  # type: ignore[no-redef]
