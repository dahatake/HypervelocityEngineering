...
- **environment の活用**: `environment: production` を設定し、承認を要求する（推奨）
...
Copilot Coding Agent が push したコミットでは GitHub Actions Workflow が自動実行されません。
...
- `environment: production` を設定し、承認を要求する
