...
description: >
  Troubleshoot and resolve issues with Azure Messaging SDKs for Event Hubs and Service Bus. USE FOR: event hub SDK error, service bus SDK issue, messaging connection failure. DO NOT USE FOR: unrelated tasks. WHEN: event hub SDK error、service bus SDK issue。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.2
