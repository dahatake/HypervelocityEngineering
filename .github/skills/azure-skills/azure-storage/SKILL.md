...
name: azure-storage
description: >
  Azure Storage Services including Blob Storage, File Shares, Queue Storage, Table Storage, and Data Lake. USE FOR: blob storage, file shares, queue storage. DO NOT USE FOR: SQL databases. WHEN: Azure Storage Services including Blob Storage, File Shares, Queue Storage, Table Storage, and Data Lakeが必要なとき。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.2
