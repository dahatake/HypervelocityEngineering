...
description: >
  Set up AI Runway on AKS — from bare cluster to running model. USE FOR: setup AI Runway, onboard AKS cluster, install AI Runway. DO NOT USE FOR: unrelated tasks. WHEN: setup AI Runway、onboard AKS cluster。
license: MIT
metadata:
  author: Microsoft
  version: 1.0.1
