# Azure Quotas - Service Limits & Capacity Management（詳細）
...
| **Complete CLI Reference** | [commands.md](commands.md) |
...
>
> For complete CLI reference, see [commands.md](commands.md).
...
> **📖 Detailed mapping examples and workflow:** See [commands.md - Resource Name Mapping](commands.md#resource-name-mapping)
...
> **📖 See also:** [commands.md](commands.md#az-quota-show) for full scripted multi-region loop patterns
...
| Resource | Link |
|----------|------|
| **CLI Commands Reference** | [commands.md](commands.md) - Complete syntax, parameters, examples |
