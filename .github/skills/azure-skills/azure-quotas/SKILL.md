...
name: azure-quotas
description: >
  Check/manage Azure quotas and usage across providers. USE FOR: check quotas, service limits, current usage. DO NOT USE FOR: unrelated tasks. WHEN: check quotas、service limits。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
...
## 目的
- Azure Quotas - Service Limits & Capacity Management の適用判断と実行フローを定義する。
