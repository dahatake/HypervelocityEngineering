...
description: >
  Architect and provision enterprise Azure infrastructure from workload descriptions. USE FOR: plan Azure infrastructure, architect Azure landing zone, design hub-spoke network. DO NOT USE FOR: unrelated tasks. WHEN: plan Azure infrastructure、architect Azure landing zone。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
