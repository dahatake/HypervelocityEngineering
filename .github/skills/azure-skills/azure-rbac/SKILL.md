...
name: azure-rbac
description: >
  Helps users find the right Azure RBAC role for an identity with least privilege access, then generate CLI commands and Bicep code to assign it. USE FOR: bicep for role assignment, what role should I assign, least privilege role. DO NOT USE FOR: unrelated tasks. WHEN: bicep for role assignment、what role should I assign。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
