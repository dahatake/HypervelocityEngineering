...
**Script:** See [first-app-registration.md](first-app-registration.md)
...
**Example:** See [console-app-example.md](console-app-example.md)
...
**Implementation:** Use Client Credentials flow (see [oauth-flows.md#client-credentials-flow](oauth-flows.md#client-credentials-flow))
...
**Complete reference:** See [cli-commands.md](cli-commands.md)
...
**Examples:** See [console-app-example.md](console-app-example.md)
...
- **Azure Identity**: [Python](sdk/azure-identity-py.md) | [.NET](sdk/azure-identity-dotnet.md) | [TypeScript](sdk/azure-identity-ts.md) | [Java](sdk/azure-identity-java.md) | [Rust](sdk/azure-identity-rust.md)
- **Key Vault (secrets)**: [Python](sdk/azure-keyvault-py.md) | [TypeScript](sdk/azure-keyvault-secrets-ts.md)
- **Auth Events**: [.NET](sdk/microsoft-azure-webjobs-extensions-authentication-events-dotnet.md)

## References

- [OAuth Flows](oauth-flows.md) - Detailed OAuth 2.0 flow explanations
- [CLI Commands](cli-commands.md) - Azure CLI reference for app registrations
- [Console App Example](console-app-example.md) - Complete working examples
- [First App Registration](first-app-registration.md) - Step-by-step guide for beginners
- [API Permissions](api-permissions.md) - Understanding and configuring permissions
