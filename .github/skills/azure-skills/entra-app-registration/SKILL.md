...
description: >
  Guides Microsoft Entra ID app registration, OAuth 2.0 authentication, and MSAL integration. USE FOR: create app registration, register Azure AD app, configure OAuth. DO NOT USE FOR: Azure RBAC or role assignments (use azure-rbac). WHEN: Guides Microsoft Entra ID app registration, OAuth 2.0 authentication, and MSAL integrationが必要なとき。
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
...
## 目的
- entra-app-registration の適用判断と実行フローを定義する。
