...
name: capacity
description: >
  Discovers available Azure OpenAI model capacity across regions and projects. USE FOR: find capacity, check quota, where can I deploy. DO NOT USE FOR: actual deployment (hand off to preset or customize after discovery). WHEN: Discovers available Azure OpenAI model capacity across regions and projectsが必要なとき。
license: MIT
metadata:
  author: Microsoft
  version: 1.0.0
...
## 目的
- Capacity Discovery の適用判断と実行フローを定義する。
