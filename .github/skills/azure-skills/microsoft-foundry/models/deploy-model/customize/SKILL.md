...
name: customize
description: >
  Interactive guided deployment flow for Azure OpenAI models with full customization control. USE FOR: custom deployment, customize model deployment, choose version. DO NOT USE FOR: quick deployment to optimal region (use preset). WHEN: Interactive guided deployment flow for Azure OpenAI models with full customization controlが必要なとき。
license: MIT
metadata:
  author: Microsoft
  version: 1.0.1
...
## 目的
- Customize Model Deployment の適用判断と実行フローを定義する。
