...
name: deploy-model
description: >
  Unified Azure OpenAI model deployment skill with intelligent intent-based routing. USE FOR: deploy model, deploy gpt, create deployment. DO NOT USE FOR: listing existing deployments (use foundry_models_deployments_list MCP tool). WHEN: Unified Azure OpenAI model deployment skill with intelligent intent-based routingが必要なとき。
license: MIT
metadata:
  author: Microsoft
  version: 1.0.0
