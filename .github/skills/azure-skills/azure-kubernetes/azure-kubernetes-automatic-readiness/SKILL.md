...
metadata:
  ...
  version: 1.0.0
description: >
  Assess Kubernetes workloads and cluster configuration for AKS Automatic compatibility. USE FOR: migrate to AKS Automatic, check AKS Automatic readiness, validate manifests for Automatic. DO NOT USE FOR: unrelated tasks. WHEN: migrate to AKS Automatic、check AKS Automatic readiness。
---
# AKS Automatic Readiness Assessment

## 目的
- AKS Automatic Readiness Assessment の適用判断と実行フローを定義する。
