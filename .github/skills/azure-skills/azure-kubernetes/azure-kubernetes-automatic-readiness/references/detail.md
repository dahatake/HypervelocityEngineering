# AKS Automatic Readiness Assessment（詳細）
...
> See [constraint spec](constraint-spec-v1.yaml) for all safeguard rules, [common fixes](common-fixes.md) for YAML patterns, [migration guide](migration-guide-summary.md) for end-to-end steps, and [MCP integration](mcp-integration.md) for tool details and fallback handling.
