<!-- DEPRECATED: このテンプレートは templates/aag/step-2.md に移動しました。 -->
{root_ref}
## 目的
...
## 依存
- Step.8.1（AI Agent アプリケーション定義）が `aad:done` であること
