...
## 入力
- `infra/azure/dataflow/create-batch-resources.sh`（Step.1.1 の成果物）
- `infra/azure/dataflow/verify-batch-resources.sh`（Step.1.1 の成果物）
...
- `infra/azure/dataflow/verify-batch-resources.sh` の実行結果が全項目 PASS であること
