---
name: Doc-NFRAnalysis
description: "非機能要件の現状分析を作成する。"
tools: ["*"]
metadata:
  version: "1.0.0"
...
io_contract:
  ...
  outputs:
    - path: "docs-generated/architecture/nfr-analysis.md"
      required: true
      mode: "create"
---
...
## 1) 目的と非目的
### 目的（MUST）
- 性能/セキュリティ/可観測性/可用性/スケーラビリティの現状を整理する。
### 非目的
- SLO/SLIの新規策定は行わない。

## 2) 入力（必ず参照）
- アーキテクチャ/依存/テスト関連サマリー
