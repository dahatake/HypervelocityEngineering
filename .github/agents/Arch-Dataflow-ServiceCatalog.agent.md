---
name: Arch-Dataflow-ServiceCatalog
description: "データフローアプリサービスカタログを docs/dataflow/dataflow-service-catalog.md に作成"
...
io_contract:
  ...
  outputs:
    ...
    - path: "knowledge/D15-非機能-運用-監視-DR-仕様書.md"
      ...
      mode: "create"
---
> **WORK**: `work/Arch-Dataflow-ServiceCatalog/Issue-<識別子>/`
