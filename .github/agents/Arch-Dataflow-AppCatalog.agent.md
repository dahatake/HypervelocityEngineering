---
name: Arch-Dataflow-AppCatalog
description: "データフローアプリ設計（一覧・依存DAG・スケジュール・リトライ）を docs/dataflow/dataflow-app-catalog.md に作成"
...
io_contract:
  inputs:
    ...
    - path: "docs/dataflow/dataflow-data-source-analysis.md"
      required: true
      kind: "agent_artifact"
      producer: "Arch-Dataflow-DataSourceAnalysis"
