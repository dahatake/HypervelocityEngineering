...
io_contract:
  ...
  outputs:
    - path: "docs-generated/components/data-model.md"
      required: true
      mode: "create"
---
> **WORK**: `work/Doc-DataModel/Issue-<識別子>/`
...
- セクション:
  - `## データモデル概要`
  - `## エンティティ一覧` テーブル `| エンティティ名 | 説明 | 主要属性 | 関連 |`
