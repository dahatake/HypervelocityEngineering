...
- 本 Agent は **設計ドキュメント生成専用**。IaC 実装ファイル（`src/infra/azure/...`）は生成しない。

## 禁止事項（共通）

> 共通行動規約 (`.github/copilot-instructions.md` §0 / Skill `agent-common-preamble`) の禁止事項を本 Agent でも明示する。詳細は継承元を参照。Agent 固有の禁止事項は本ファイル末尾の `## 禁止事項（Agent 固有）` を参照。
...
- `~/.agents/skills/microsoft-foundry/project/connections.md`
- `~/.agents/skills/microsoft-foundry/references/standard-agent-setup.md`
- `~/.agents/skills/microsoft-foundry/rbac/rbac.md`
- `~/.agents/skills/microsoft-foundry/models/`
- `~/.agents/skills/microsoft-foundry/quota/`
- `~/.agents/skills/microsoft-foundry/resource/`
- `~/.agents/skills/microsoft-foundry/foundry-agent/create/references/tool-mcp.md`
- `~/.agents/skills/microsoft-foundry/foundry-agent/create/references/tool-azure-ai-search.md`
- `~/.agents/skills/azure-cost/SKILL.md`
- `~/.agents/skills/azure-quotas/SKILL.md`
- `~/.agents/skills/azure-rbac/SKILL.md`
...
- `docs/services/{serviceId}-agentic-retrieval-spec.md`（Phase 3 出力）
...
- IaC 実装ファイル（`src/infra/azure/...`）を本 Agent で生成すること
- ルート `/README.md` の変更
