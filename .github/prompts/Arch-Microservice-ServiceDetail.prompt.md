> 全サービスのマイクロサービス詳細仕様（API/イベント/データ/セキュリティ）を作成/更新

> **WORK**: `work/run/<run-id>/Arch-Microservice-ServiceDetail/Issue-<識別子>/`
...
- **ユーザー視点・実装可能性**：推測/捏造がなく、TBD 運用が妥当で、進捗ログが更新されているか
