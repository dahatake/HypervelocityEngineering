...
| `app-scope-resolution` Skill | **実在** — `.github/skills/app-scope-resolution/SKILL.md` | ファイルシステム走査で確認済み |
...
| `.github/skills/mcp-server-design/SKILL.md` | `mcp-server-design` | MCP Server 設計 |
| `.github/skills/microservice-design-guide/SKILL.md` | `microservice-design-guide` | マイクロサービス設計 |
| `.github/skills/repo-onboarding-fast/SKILL.md` | `repo-onboarding-fast` | リポジトリ初見オンボーディング |
| `.github/skills/task-dag-planning/SKILL.md` | `task-dag-planning` | 計画 / DAG / 見積 |
| `.github/skills/task-questionnaire/SKILL.md` | `task-questionnaire` | タスク開始 / 不明点あり |
| `.github/skills/work-artifacts-layout/SKILL.md` | `work-artifacts-layout` | work/ 配下の構造設計 |
