...
## 目的
ARD ワークフロー Step 2.1（任意）。事業要件文書の **戦略的記述**（To-Be ビジョン / 戦略的方向性 / 戦略的アクションプラン / 主要 KPI に相当する記述）を根拠に、KPI/OKR、計測データ定義、目的志向のデータ収集設計を作成し、`docs/recommended-kpi-okr.md` を生成する。
...
## 後続工程での参照
- ARD Step 3.1（ユースケース骨格）/ Step 3.2（ユースケース詳細）が **任意参照**
