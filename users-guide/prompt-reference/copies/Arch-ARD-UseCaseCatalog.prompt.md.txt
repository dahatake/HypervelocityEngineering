...
| Step | 役割 | 出力先 |
|---|---|---|
| 3.1 | ユースケース骨格抽出 | `docs/catalog/use-case-skeleton.md` |
| 3.2 | ユースケース詳細生成（per-UC fan-out） | `docs/usecase/{key}-detail.md`（例: `docs/usecase/UC-01-detail.md`）|
| 3.3 | ユースケースカタログ統合 | `docs/catalog/use-case-catalog.md` |

- Step 3.2 では `docs/catalog/` 配下に per-UC ファイルを作成してはならない。`docs/catalog/use-cases/` 等のサブディレクトリ作成も禁止。
