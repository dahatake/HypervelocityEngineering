...
|---|---|---|---|
| step-1.1 | [`Dev-Batch-Deploy`](../.github/agents/Dev-Batch-Deploy.agent.md) | `docs/batch/batch-service-catalog.md` | Azure データ/コンピュート準備成果物（`infra/azure/` など） |
| step-1.2 | [`Dev-Batch-Deploy`](../.github/agents/Dev-Batch-Deploy.agent.md) | `docs/batch/batch-service-catalog.md`, step-1.1 成果物 | Azure リソース構築成果物（`infra/azure/` など） |
...
| step-3 | [`Dev-Batch-Deploy`](../.github/agents/Dev-Batch-Deploy.agent.md) | step-2.2 成果物 | デプロイ成果物（ワークフロー/スクリプト類） |
| step-4.1 | [`QA-AzureArchitectureReview`](../.github/agents/QA-AzureArchitectureReview.agent.md) | step-3 成果物 | `docs/azure/azure-architecture-review-report.md` |
| step-4.2 | [`QA-AzureDependencyReview`](../.github/agents/QA-AzureDependencyReview.agent.md) | step-3 成果物 | `docs/azure/dependency-review-report.md` |
...
3. 以下の成果物が PR に反映されていることを確認する
   - step-1.1 / step-1.2: `infra/azure/` 配下のリソース作成・検証スクリプト
   - step-2.1: `test/batch/{jobId}-{jobNameSlug}.Tests/`
   - step-2.2: `src/batch/` 実装コード
   - step-3: `.github/workflows/` およびデプロイ関連スクリプト
...
| Agent 名 | ファイル | 主な用途 |
|---|---|---|
| `Dev-Batch-Deploy` | [`.github/agents/Dev-Batch-Deploy.agent.md`](../.github/agents/Dev-Batch-Deploy.agent.md) | バッチ関連 Azure リソースの構築・デプロイ |
| `Dev-Batch-TestCoding` | [`.github/agents/Dev-Batch-TestCoding.agent.md`](../.github/agents/Dev-Batch-TestCoding.agent.md) | バッチ TDD RED フェーズ（テストコード生成） |
| `Dev-Batch-ServiceCoding` | [`.github/agents/Dev-Batch-ServiceCoding.agent.md`](../.github/agents/Dev-Batch-ServiceCoding.agent.md) | バッチ TDD GREEN フェーズ（実装） |
| `QA-AzureArchitectureReview` | [`.github/agents/QA-AzureArchitectureReview.agent.md`](../.github/agents/QA-AzureArchitectureReview.agent.md) | WAF/ASB 観点のアーキテクチャレビュー |
| `QA-AzureDependencyReview` | [`.github/agents/QA-AzureDependencyReview.agent.md`](../.github/agents/QA-AzureDependencyReview.agent.md) | Azure 依存関係・設定整合レビュー |
...
| ファイル | Step | 成果物 |
|---|---|---|
| [`.github/agents/Dev-Batch-Deploy.agent.md`](../.github/agents/Dev-Batch-Deploy.agent.md) | step-1.1, step-1.2, step-3 | `infra/azure/` 配下のデプロイスクリプト・検証成果物 |
