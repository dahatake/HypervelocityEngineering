...
2. テンプレート一覧から **"Batch Design"** を選択して **"Get started"** をクリック

> 📄 テンプレートファイル: [`.github/ISSUE_TEMPLATE/batch-design.yml`](../.github/ISSUE_TEMPLATE/batch-design.yml)
...
- Actions タブで **"Batch Design - Bootstrap"** ジョブが起動したことを確認してください
...
| ファイル | 用途 |
|---|---|
| [`.github/ISSUE_TEMPLATE/batch-design.yml`](../.github/ISSUE_TEMPLATE/batch-design.yml) | ABD ワークフロー起動用テンプレート |
