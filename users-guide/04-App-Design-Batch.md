...
|-----------|---------------------------------------------|-------------------------------|----------------------------------------------------------------------------------------------|---------------------------------------------------------|---------------------------|
| step-1.1  | Step.1.1 バッチドメイン分析                 | Arch-Batch-DomainAnalytics     | docs/usecase-list.md                                                                         | docs/batch/batch-domain-analytics.md                    | なし                      |
| step-1.2  | Step.1.2 データソース/デスティネーション分析 | Arch-Batch-DataSourceAnalysis  | docs/usecase-list.md, docs/data-model.md（任意）                                             | docs/batch/batch-data-source-analysis.md                | なし                      |
| step-2    | Step.2 バッチデータモデル                   | Arch-Batch-DataModel           | docs/batch/batch-domain-analytics.md, docs/batch/batch-data-source-analysis.md, docs/data-model.md | docs/batch/batch-data-model.md                   | step-1.1 AND step-1.2     |
...
> [!TIP]
> Step.1.1 と Step.1.2 は並列で実行できます。いずれも主な入力は `docs/usecase-list.md` であり、Step.1.2 では必要に応じて `docs/data-model.md` も併用できるため、同時に依頼しても構いません。
...
- `docs/data-model.md`（存在する場合のみ。任意）
...
2. テンプレート **"Auto Batch Design Workflow"** を選択
3. 以下を入力:
...
1. `.github/ISSUE_TEMPLATE/auto-batch-design.yml` がリポジトリに存在することを確認する
2. Issues タブ → New Issue → **Auto Batch Design Workflow** テンプレートが表示されることを確認する
