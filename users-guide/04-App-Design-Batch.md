...
| step-6.3  | Step.6.3 TDDテスト仕様書                    | Arch-Batch-TDD-TestSpec        | docs/batch/batch-test-strategy.md, docs/batch/batch-service-catalog.md, docs/batch/jobs/*-spec.md, docs/batch/batch-monitoring-design.md | docs/test-specs/{jobId}-test-spec.md           | step-6.1 AND step-6.2     |
